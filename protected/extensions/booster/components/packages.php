...
return array(
    ...
    'kartik-fileupload' => array(
        'depends' => array('jquery'),
        'baseUrl' => $this->getAssetsUrl() . '/kartik-fileupload/', // Not in CDN yet
        'css' => array($this->minify ? 'css/fileinput.min.css' : 'fileinput.css'),
        'js' => array(
            $this->minify ? 'js/fileinput.min.js' : 'js/fileinput.js',
