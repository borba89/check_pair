...
class Comment extends CActiveRecord {
    ...
    private $_statuses = array(
        self::STATUS_NOT_APPROWED=>'Новый',
        self::STATUS_APPROWED=>'Одобрен',
    ...
    public function rules() {
        ...
        $rules = array(
            ...
            array('owner_id, parent_id, creator_id, create_time, update_time, status', 'numerical', 'integerOnly' => true),
            ...
            array('owner_name, owner_id, id, parent_id, creator_id, user_name, user_email, comment_text, create_time, update_time, status', 'safe', 'on' => 'search'),
        );
    ...
    public function relations() {
        $relations = array(
            ...
            'blog' => array(self::BELONGS_TO, 'BlogArticle', 'owner_id'),
        );
    ...
    public function attributeLabels() {
        return array(
            ...
            'comment_text' => Yii::t('CommentsModule.msg', 'Текст комментария'),
            'create_time' => Yii::t('CommentsModule.msg', 'Create Time'),
            'update_time' => Yii::t('CommentsModule.msg', 'Update Time'),
            'status' => Yii::t('CommentsModule.msg', 'Статус'),
            'verifyCode' => Yii::t('MainModule.main', 'Проверочный код'),
        );
    }
    ...
    public function getUserName() {
        ...
        if (isset($this->user)) {
            ...
            $userConfig = Yii::app()->getModule('comments')->userConfig;
            $name = $userConfig['nameProperty'];
            $userName .= $this->user->$name;
            if (isset($userConfig['emailProperty'])){
                $emailProperty = $userConfig['emailProperty'];
                $userName .= '(' . $this->user->$emailProperty . ')';
            }
    ...
    {
        $model = BlogArticle::model()->findByAttributes(array('id'=>$this->owner_id));
