                        ...
                        <div class="flex items-center center-xs space-between-sm up">
                            <div class="text-center-xs">
                                ...
                                <div class="hover-red c-white size-1_2em-sm size-1_5em-sm">
                                    <?php echo $realty->addressTable->street; ?>
                                </div>
                            </div>
                            <div class="text-center-xs text-right-sm">
                                <div class="hover-red c-white size-1_4em-xs size-1_9em-sm">
                                    <?php echo $model->getType($this->getPostValue('type')); ?>,
                                    <?php echo $realty->realtyDetailed->total_space_size; ?>
                                    <?php echo $realty->realtyDetailed->getSpaseSizeUnitView(
                                        $realty->realtyDetailed->space_size_units
                                    ); ?>
                                </div>
                                <div class="hover-red c-white size-1_2em-sm size-1_5em-sm">
