        ...
        if(($n=count($data))>0)
        {
            ...
            foreach($data as $i=>$item)
            {
                ...
                if ($this->articleData) {
                    ...
                    echo CHtml::tag('div', array('class' => 'h5 pr-0_5em c-green'), YHelper::formatDate('yyyy,', $item->created, 'yyyy-MM-dd'));
                    echo CHtml::tag('div', array('class' => 'h5 c-green'), YHelper::formatDate('dd MMMM', $item->created, 'yyyy-MM-dd'));
                    echo CHtml::closeTag('div');
                }
