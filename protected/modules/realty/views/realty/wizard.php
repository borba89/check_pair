        ...
        <div class="row">
            <div class="col m12">
                <div class="row">
                    ...
                    <?php echo $form->dropDownListGroup($model, 'broker_id', User::model()->getUsersByRole('broker'), array('class'=>'', 'empty' => 'Назначьте брокера')); ?>

                    <?php echo $form->dropDownListGroup($model, 'type', Realty::model()->getRealtyType(), array('class'=>'required')); ?>

                    <?php echo $form->dropDownListGroup($address, 'country', RealtyAddress::model()->getCountries(), array('class'=>'required', 'prompt' => 'Укажите страну')); ?>

                    <?php echo $form->dropDownListGroup($address, 'city', RealtyAddress::model()->getCities(), $disabled + array('class'=>'required', 'prompt' => 'Укажите город')); ?>

                    <?php echo $form->dropDownListGroup($address, 'city_district', RealtyAddress::model()->getDistrict(), $disabled + array('class'=>'required', 'prompt' => 'Укажите район')); ?>
