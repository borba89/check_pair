...
<div class="card-content">
    ...
    <?php if(isset($subtype)):?>
        Тип объекта: <?php echo RealtyDetailedDescription::model()->previewSubtype($type, $subtype); ?><br>
    <?php endif;?>
...
<div class="card-content">
    ...
    <?php if (isset($space_size_units)) { ?>
        ...
        <?php echo RealtyDetailedDescription::model()->getSpaseSizeUnitView($space_size_units); ?><br>
    <?php } ?>
