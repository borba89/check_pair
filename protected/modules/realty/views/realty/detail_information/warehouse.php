...
<?php echo $form->dropDownListGroup($realtyDetailed, 'space_size_units', RealtyDetailedDescription::model()->getSpaseSizeUnits(), array('class'=>'required', 'prompt' => 'Select space size unit', 'labelOptions' => array('class' => 'active'))); ?>
