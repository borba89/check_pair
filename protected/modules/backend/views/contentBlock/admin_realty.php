...
$this->title = Yii::t('BackendModule.backend','Управление блоками контента - типы недвижимости');
...
$this->menu=array(
    array('label'=>Yii::t('BackendModule.backend','Создать блок контента'), 'url'=>array('createRealty')),
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo Yii::t('BackendModule.backend', 'Типы-недвижимости')?></li>
</ol>
...
//                'width' => '360px',
            ...
            */
            array(
                ...
                'buttons' => array(
                    'update' => array(
                        'url' => 'Yii::app()->createUrl("/backend/contentBlock/updateRealty", array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                    ),
                )
