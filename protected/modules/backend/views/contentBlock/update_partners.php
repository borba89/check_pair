...
$this->title = Yii::t('BackendModule.backend','Редактирование блока контента - партнеры');

$this->breadcrumbs=array(
    Yii::t('BackendModule.backend','Управление блоками контента')=>array('admin'),
    $model->name=>array('view','id'=>$model->id),
    Yii::t('BackendModule.backend','Редактирование'),
);

$this->menu=array(
    array('label'=>Yii::t('BackendModule.backend', 'Отмена'), 'url'=>'#', 'linkOptions'=>array('submit'=>array('/backend/contentBlock/adminPartners'),'confirm'=>Yii::t('BackendModule.backend', 'Внесённые изменения не будут сохранены. Выйти?'))),
);
?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo Yii::app()->createUrl('/backend/contentBlock/adminPartners') ?>"><?php echo Yii::t('BackendModule.backend', 'Партнеры')?></a></li>
...
<?php $this->renderPartial('_form_partners', array('model'=>$model)); ?>