...
$this->title = Yii::t('BackendModule.backend','Управление блоками контента - '.$label);
...
$this->menu=array(
	array('label'=>Yii::t('BackendModule.backend','Создать блок контента'), 'url'=>array('create')),
...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page"><?php echo Yii::t('BackendModule.backend', $labelBig)?></li>
</ol>
