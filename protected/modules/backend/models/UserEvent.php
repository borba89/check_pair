...
class UserEvent extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, event_id', 'safe', 'on'=>'search'),
            array('invitation_date', 'default', 'value' => date('Y-m-d'), 'setOnEmpty' => false, 'on' => 'insert'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'invitation' => array(self::BELONGS_TO, 'EventInvitation', 'event_id'),
		);
	}
